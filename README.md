...
Built with Next.js, TailwindCSS, and TypeScript, this landing page serves as a hands-on project to reinforce one's understanding of these technologies.
...
```bash
git clone git@github.com:lorsim/travel-app.git
cd travel-app
```
